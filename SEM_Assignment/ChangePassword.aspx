...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div class="container justify-content-center mt-5 my-3">
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-5 bg-light container justify-content-center p-4 shadow rounded">
                <asp:ChangePassword ID="ChangePassword1" runat="server">
                    <ChangePasswordTemplate>
                        <div >
                            <table cellpadding="1" class="justify-content-center"style="border-collapse:collapse;">
                                <tr>
                                    <td>
                                        <table>
                                            <tr>
